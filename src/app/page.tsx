...
import CleanLandingSections from "@/components/CleanLandingSections";
        ...
        <div className="relative rounded-3xl p-12 bg-gradient-to-br from-violet-500/10 to-blue-500/10 border border-violet-500/20 overflow-hidden">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-64 h-64 rounded-full bg-violet-500/10 blur-3xl" />
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link href="/auth/register"><Button variant="primary" size="lg">Start Free <ArrowRight size={16} /></Button></Link>
              <Link href="/dashboard"><Button variant="secondary" size="lg">View Demo</Button></Link>
            </div>
          </div>
        </div>
      </div>
